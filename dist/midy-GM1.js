...
export var MidyGM1 = /*#__PURE__*/ function() {
    "use strict";
    function MidyGM1(audioContext) {
        _class_call_check(this, MidyGM1);
    ...
    _create_class(MidyGM1, [
        ...
        },
        {
            ...
            value: function calcSemitoneOffset(channel) {
                var tuning = channel.coarseTuning + channel.fineTuning;
...
_define_property(MidyGM1, "channelSettings", {
    volume: 100 / 127,
    pan: 64,
    bank: 0,
    dataMSB: 0,
...
_define_property(MidyGM1, "effectSettings", {
    expression: 1,
    modulationDepth: 0,
    sustainPedal: false,
    rpnMSB: 127,
