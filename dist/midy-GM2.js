...
export var MidyGM2 = /*#__PURE__*/ function() {
    "use strict";
    function MidyGM2(audioContext) {
        var _this = this;
        var options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.defaultOptions;
        _class_call_check(this, MidyGM2);
    ...
    _create_class(MidyGM2, [
        ...
        },
        {
            ...
            value: function setPortamentoStartFilterEnvelope(channel, note) {
                ...
                var baseFreq = this.centToHz(instrumentKey.initialFilterFc) * softPedalFactor;
                var peekFreq = this.centToHz(instrumentKey.initialFilterFc + instrumentKey.modEnvToFilterFc) * softPedalFactor;
...
_define_property(MidyGM2, "channelSettings", {
...
_define_property(MidyGM2, "effectSettings", {
    expression: 1,
    modulationDepth: 0,
    sustainPedal: false,
    portamento: false,
...
_define_property(MidyGM2, "controllerDestinationSettings", {
    pitchControl: 0,
