...
export class MidyGM2 extends Player<Note, Channel> {
  ...
  override async render(): Promise<AudioBuffer | undefined> {
  ...
  override async createAdsRenderedBuffer(
    channel: Channel,
    note: Note,
    voiceParams: VoiceParams,
  ...
  override async createAdsrRenderedBuffer(
    channel: Channel,
    note: Note,
    voiceParams: VoiceParams,
    audioBuffer: AudioBuffer,
  ...
  override async renderSegmentBuffer(
    channel: Channel,
    segment: OpenSegment,
  ): Promise<AudioBuffer | null> {
  ...
  override async createFullRenderedBuffer(
    channel: Channel,
