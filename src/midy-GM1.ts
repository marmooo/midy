...
export class Channel {
  ...
  setCoarseTuning(value: number, scheduleTime?: number) { // [-6400, 6300] cent
    const player = this.player;
    const t: number = scheduleTime ?? player.audioContext.currentTime;
  ...
  resetAllControllers(scheduleTime?: number): void {
    ...
    const channelSettings =
      (player.constructor as typeof MidyGM1).channelSettings;
...
export class MidyGM1 extends EventTarget {
  ...
  async createSegmentNoteBuffer(
    ...
    const offlinePlayer = new (this.constructor as typeof MidyGM1)(
